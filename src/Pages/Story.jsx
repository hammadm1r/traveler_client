...
const videoData = [
  {
    latitude: 51.505,
    longitude: -0.09,
    videoUrl: "https://videos.pexels.com/video-files/4434242/4434242-uhd_2160_3840_24fps.mp4",  // Replace with valid URL
    title: "Video 1"
  },
  {
    latitude: 51.515,
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row">
        {/* Map Section */}
        <div className="flex-grow h-[80vh] md:w-2/3 relative z-0"> {/* Set z-index for the map */}
          <MapContainer
          ...
          createPortal(
            ...
            >
              ...
              >
                ...
                {/* Title */}
                <div className="absolute bottom-4 left-4 text-white text-lg font-semibold bg-black bg-opacity-50 px-4 py-2 rounded-md">
                  {selectedVideo.title}
                </div>
                ...
                <button
                  ...
                  onClick={(e) => e.stopPropagation()} // Prevent closing when clicking like button
                >
                  ❤️ Like
                </button>
              </div>
