    ...
    <div className='bg-transparent absolute top-0 left-0 w-full z-10 p-4 sm:p-6 flex items-center justify-between'>
      ...
      <div className='justify-center md:block hidden'>
        <ul className='flex gap-7'>
          <li className='text-white text-lg font-semibold hover:text-blue-400'><Link to="/home">Home</Link></li>
          <li className='text-white text-lg font-semibold hover:text-blue-400'><Link to="/story">Story</Link></li>
          <li className='text-white text-lg font-semibold hover:text-blue-400'><Link to="/forum">Forum</Link></li>
          <li className='text-white text-lg font-semibold hover:text-blue-400'>Travel Advisor</li>
          <li className='text-white text-right text-3xl font-semibold hover:text-blue-400'><FaCircleUser /></li>
        </ul>
      </div>
      <div className='md:hidden block'>
        ...
        {isMenuOpen && (
          ...
          <ul className='flex flex-col items-center p-6 gap-3 transition-all duration-300 ease-in-out'>
            ...
            <li className='text-white text-lg font-semibold hover:text-blue-400 transition-colors duration-200'>
              <Link to="/story" onClick={() => setIsMenuOpen(false)}>Story</Link>
            </li>
            <li className='text-white text-lg font-semibold hover:text-blue-400 transition-colors duration-200'>
